...
}, k = (e, t, s, r = []) => e.reduce(gt(t, s), r).flat(), gt = (e, t) => (s, r) => r ? Array.isArray(r) ? k(
  r,
  e,
  t,
  s
...
class Et {
  constructor(t, s, r = []) {
    ...
    this.events = n, this.attributes = o, this.isSvg = ot(this.type, this.attributes.xmlns), this.children = new O(r);
  }
  render(t) {
...
const At = (e, t, s) => {
...
}, M = "go-to-href", m = "navigation:location-change", $ = "navigation:route-change", St = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  ...
  const { state: s, publish: r, window: n } = t, { host: o, pathname: a, search: h } = n.location, u = a, d = B(h), c = {
    host: o,
    path: u,
    query: d
  };
...
class R {
  constructor({ window: t, document: s, publish: r, subscribe: n, bus: o, state: a, renderKit: h }) {
    this.window = t, this.document = s, this.publish = r, this.subscribe = n, this.bus = o, this.state = a, this.renderKit = h, this.roots = [];
  }
  render(t, s) {
...
class J {
  constructor() {
    this.exactSubscriptions = new q(), this.fuzzySubscriptions = new I(), this.currentIndex = 0;
  }
  subscribe(t, s) {
    let r;
...
const H = () => {
  ...
  const r = e[s], n = t[s];
  return x(r, n);
}), Ot = (e, t) => !(f(e) && f(t)) || e.length !== t.length ? !1 : e.every((s, r) => {
  const n = t[r];
  return x(s, n);
...
const W = (e) => new Q(e), xe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  State: Q,
  Store: y,
...
}, Symbol.toStringTag, { value: "Module" })), $t = (e, t) => ({
  source: e,
  target: t,
  type: i.changeText,
  data: {}
...
const N = (e) => {
  ...
  const r = [], n = e.attributes, o = n.length, a = t.attributes, h = a.length;
  let u, d, c;
  for (u = 0; u < o; u++) {
    c = null;
    const l = n.item(u);
...
}, qt = (e) => e.tagName !== "INPUT", It = (e, t) => e.value === t.value, Jt = (e, t) => {
  if (qt(e) || It(e, t))
    return [];
  const s = e, r = t;
  return [zt(s, r, { name: "value", value: r.value })];
}, Ht = (e, t) => {
  const s = X(e, t), r = Rt(e, t), n = Jt(e, t);
  return s.concat(r).concat(n);
}, Gt = (e, t) => X(e, t, !0), Ct = (e, t) => e.textContent !== t.textContent ? [$t(e, t)] : [], Qt = (e, t, s) => {
  let r = [];
  if (e.nodeType === 1 && ut(e)) {
    const n = e, o = t, a = Gt(n, o), h = s(
      n.childNodes,
      o.childNodes,
      n
    );
  ...
  const r = [], n = Wt(e, t), o = N(e), a = N(t), h = [];
  let u = 0;
  for (; u < n; u++) {
    const c = e[u], l = t[u];
    if (l && a.check(l)) {
      const p = o.pullMatch(l);
      a.clear(l), p.element ? (p.index !== u && r.push(
        v(p.element, {
          parent: s,
          index: u
        })
...
class ve {
  ...
  rerender() {
    ...
    const t = this.generateDom(this.renderKit), s = Xt(
      this.dom,
      t,
      this.parentElement
    );
...
const ge = (e) => e, Se = ({
  ...
  viewModel: t,
  subscriptions: s
}) => (s = s || [], t = t || ge, (r) => new ve({ Template: e, viewModel: t, subscriptions: s, attributes: r })), _e = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createRouteState: F,
  events: St,
