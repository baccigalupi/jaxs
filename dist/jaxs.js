...
const ut = (e) => typeof e == 'string' || typeof e == 'number',
  ht = (e) => new ct(e),
  lt = (e) => (ut(e) ? ht(e) : e),
  dt = (e) => (t) => (t && (t.isSvg = t.isSvg || e), t),
  pt = (e, t) => mt(e).map(lt).flat().map(dt(t)),
...
class Et {
  constructor(t, s, n = [], r = !1) {
    ...
    ;(this.events = o),
      (this.attributes = a),
      (this.isSvg = r || rt(this.type)),
      (this.children = new O(n, this.isSvg))
  }
  render(t) {
...
const I = () => {
  ...
  b = (e) => Array.isArray(e),
  g = (e) => e !== null && !b(e) && typeof e == 'object',
  Nt = (e, t) => e === t,
...
const ve = /* @__PURE__ */ Object.freeze(
  ...
  Bt = (e, t) => (e.type > t.type ? 1 : e.type < t.type ? -1 : 0),
  S = { index: -1 }
class Kt {
  constructor() {
    this.map = {}
...
const _ = (e) => {
    ...
    for (i = 0; i < o; i++) {
      ...
      if (l) {
        ...
        u
          ...
          : n.push(Tt(e, t, { name: l.name, isSvg: s }))
      }
    }
    for (i = 0; i < h; i++) {
      u = null
  ...
  Jt = (e) => e.tagName !== 'INPUT',
  qt = (e, t) => e.value === t.value,
  Ht = (e, t) => {
    if (Jt(e) || qt(e, t)) return []
    const s = e,
      n = t
  ...
  Qt = (e, t) => Y(e, t, !0),
  Wt = (e, t) => (e.textContent !== t.textContent ? [Mt(e, t)] : []),
  Gt = (e, t, s) => {
    let n = []
  ...
  Z = (e, t, s) => {
      ...
      if (l && a.check(l)) {
        ...
        a.clear(l),
          p.element
            ...
            : u
              ? a.check(u)
                ? n.push(v(l, { parent: s, index: i }))
                : (o.clear(u), n.push(Ft(u, l)))
              : n.push(v(l, { parent: s, index: i }))
    ...
    const d = h.reduce(
      (u, { source: l, target: p }) => u.concat(Gt(l, p, Z)),
      [],
    )
...
class le {
  ...
  rerender() {
    ...
    Yt(this.dom, t, this.parentElement),
      this.parentElement &&
...
const de = (e) => e,
  ge = ({ Template: e, viewModel: t, subscriptions: s }) => (
    (s = s || []),
    (t = t || de),
    (n) =>
      new le({ Template: e, viewModel: t, subscriptions: s, attributes: n })
  ),
