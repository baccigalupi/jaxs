...
import { compileChildren } from '../../../lib/rendering/change/instructions/children.ts';
...
describe('compileChildren: add, remove, replace and move operations', () => {
  ...
  it('leaves identical text as is', () => {
  ...
  it('replaces text with an element', () => {
  ...
  it('replaces an element with text', () => {
    const sourceTemplate = (
      <>
        <p>Hello</p>
        <p>Here is some content!</p>
  ...
  it('reduces the source when the target removes an item', () => {
    const sourceTemplate = (
      <>
        <p>Hello</p>
        <p>Here is some content!</p>
  ...
  it('adds to the end of the source when the target has added an item there', () => {
    const sourceTemplate = (
      <>
        <p>Hello</p>
      </>
  ...
  it('creates insert instructions when the same element gets reordeded', () => {
    const sourceTemplate = (
      <>
        <h1>Email</h1>
  ...
  it('adds an element in the middle and shifts the remainder down', () => {
    const sourceTemplate = (
      <>
        <h1>Email</h1>
  ...
  it('does the right recursion stuff when updating a child', () => {
    const sourceTemplate = (
      <div class='foo'>
        Foo is happening
      </div>
  ...
  it('completely swaps out content', () => {
    const sourceTemplate = (
      <>
