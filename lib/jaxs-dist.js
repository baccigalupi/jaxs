...
(function (ChangeInstructions) {
  ...
  ChangeInstructions[ChangeInstructions['removeAttribute'] = 4] =
    'removeAttribute';
  ChangeInstructions[ChangeInstructions['addAttribute'] = 5] = 'addAttribute';
  ChangeInstructions[ChangeInstructions['updateAttribute'] = 6] =
    'updateAttribute';
...
const shouldCompileChildren = (baseInstructions) => {
  ...
  for (index = 0; index < largerLength; index++) {
    ...
    if (!sourceChild) {
      ...
      instructions = instructions.concat(
        compileForDom(sourceChild, targetChild),
      );
    }
  }
  return instructions;
